 ...
 */
final class Version20210116150721 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, comment_by_id INT NOT NULL, content VARCHAR(255) NOT NULL, status TINYINT(1) NOT NULL, INDEX IDX_9474526C37DB8F5 (comment_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
