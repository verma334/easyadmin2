...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Comment::class, mappedBy="commentBy", orphanRemoval=true)
     */
    private $createdAt;

    /**
     * @ORM\OneToMany(targetEntity=Post::class, mappedBy="postby")
     */
    private $posts;
    ...
    public function removeCreatedAt(Comment $createdAt): self
    {
        if ($this->createdAt->removeElement($createdAt)) {
            ...
            if ($createdAt->getCommentBy() === $this) {
                $createdAt->setCommentBy(null);
            }
        }
